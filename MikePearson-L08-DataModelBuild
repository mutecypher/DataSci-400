...
# -*- coding: utf-8 -*-
"""
Created on Sat Sep 15 08:13:21 2018
...
## so This is basically a re-use of Milestone 2 code, from here to line 329
...
## To summarize, I imported, normalized and split the Hungarian heart disease
## data from the UCI Machine Learning Database
## I separated the data set into 20% training and 80% testing
## I used the Support Vector Machine learning algorithm
## Of the 235 actual heart disease diagnoses in the data set, 33
## differed from the SVM prediction when I ran it